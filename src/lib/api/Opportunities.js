//---------------------------------------------------------------------------
// Module:  $lib/api/Opportunities.js
//
...
export async function getOpportunities() {
	try {
		const response = await fetch(`${STRAPI_SERVER_URL}/api/opportunities?populate=*`, {
			method: 'GET',
		...
		else console.log('Failed to load job opportunities', err);
	}
